...
<>
    <Modal ref={modal} buttonCaption="Okay">
        ...
        <p className="text-stone-600 mb-4"> Ooops, Please enter a value </p>
        <p className="text-stone-600 mb-4"> Please ensure you provide a valid value for every input field</p>
    </Modal>
